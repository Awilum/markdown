...
REPO_URL="https://github.com/Awilum/markdown"
...
for LOCALE in "${LOCALES[@]}"; do
  ...
  if [[ "$LOCALE" == "ru" ]]; then
    TITLE="Об издании"
    DESC_1="Перед вами экземпляр книги **Markdown**, собранный из исходного репозитория Git."
    ...
    DESC_1="This copy of **Markdown** was generated from the Git repository."
...
EOF
  ...
  RESOURCE_PATH="$SRC_DIR:$SRC_DIR/images:$GEN_DIR"
